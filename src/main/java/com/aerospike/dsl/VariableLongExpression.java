...
/**
 * Wrapper class that allows VariableExpression to be used in Long arithmetic operations.
 */
public class VariableLongExpression implements LongExpression {
    private final VariableExpression varExpr;

    public VariableLongExpression(VariableExpression varExpr) {
    ...
    public String toString() {
        return varExpr.toString();
    }

    @Override
    public String toAerospikeExpr() {
        return varExpr.toAerospikeExpr();
    }
    
    @Override
    public Exp toAerospikeExp() {
        return varExpr.toAerospikeExp();
    }
} 