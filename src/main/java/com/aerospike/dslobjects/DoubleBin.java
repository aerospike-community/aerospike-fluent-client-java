...
/**
 * Represents a Double bin in an Aerospike record.
 */
public class DoubleBin implements DoubleExpression {
    private final String name;

    public DoubleBin(String name) {
        this.name = name;
    }
    ...
    public DoubleExpression add(IfExpression ifExpr) {
        return new DoubleArithmeticExpression(this, ArithmeticOp.PLUS, new IfDoubleExpression(ifExpr));
    }

    public DoubleExpression sub(IfExpression ifExpr) {
        return new DoubleArithmeticExpression(this, ArithmeticOp.MINUS, new IfDoubleExpression(ifExpr));
    }

    public DoubleExpression mul(IfExpression ifExpr) {
        return new DoubleArithmeticExpression(this, ArithmeticOp.TIMES, new IfDoubleExpression(ifExpr));
    }

    public DoubleExpression div(IfExpression ifExpr) {
        return new DoubleArithmeticExpression(this, ArithmeticOp.DIV, new IfDoubleExpression(ifExpr));
    }
